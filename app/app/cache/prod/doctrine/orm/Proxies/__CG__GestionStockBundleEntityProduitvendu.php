 ...
 */
class Produitvendu extends \Gestion\StockBundle\Entity\Produitvendu implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Gestion\\StockBundle\\Entity\\Produitvendu' . "\0" . 'id', '' . "\0" . 'Gestion\\StockBundle\\Entity\\Produitvendu' . "\0" . 'quantite', '' . "\0" . 'Gestion\\StockBundle\\Entity\\Produitvendu' . "\0" . 'idproduit'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Produitvendu $proxy) {
