 ...
 */
class Client extends \Gestion\StockBundle\Entity\Client implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Gestion\\StockBundle\\Entity\\Client' . "\0" . 'id', '' . "\0" . 'Gestion\\StockBundle\\Entity\\Client' . "\0" . 'nom', '' . "\0" . 'Gestion\\StockBundle\\Entity\\Client' . "\0" . 'prenom', '' . "\0" . 'Gestion\\StockBundle\\Entity\\Client' . "\0" . 'cin', '' . "\0" . 'Gestion\\StockBundle\\Entity\\Client' . "\0" . 'tel', '' . "\0" . 'Gestion\\StockBundle\\Entity\\Client' . "\0" . 'mail'];
        }
