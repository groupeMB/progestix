 ...
 */
class Stock extends \Gestion\StockBundle\Entity\Stock implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Gestion\\StockBundle\\Entity\\Stock' . "\0" . 'id', '' . "\0" . 'Gestion\\StockBundle\\Entity\\Stock' . "\0" . 'quantite', '' . "\0" . 'Gestion\\StockBundle\\Entity\\Stock' . "\0" . 'seuilmin', '' . "\0" . 'Gestion\\StockBundle\\Entity\\Stock' . "\0" . 'produit', 'produitTemp'];
        }
